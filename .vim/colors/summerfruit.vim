...
hi LineNr       term=bold cterm=bold ctermfg=brown guifg=#eeeeee   guibg=#438ec3   gui=bold
hi MatchParen   guibg=#cddae5
hi TabLineFill term=bold ctermfg=black
hi TabLine term=reverse cterm=reverse ctermfg=black ctermbg=white
hi TabLineSel term=bold cterm=bold ctermfg=white ctermbg=darkgreen
" Specials
...
" Syntax Elements
hi String     term=bold cterm=bold ctermfg=gray  guifg=#0086d2
...
hi Comment	term=bold ctermfg=green guifg=cyan4
...
hi Delimiter term=bold cterm=bold ctermfg=magenta
"tab marks
